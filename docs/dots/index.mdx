...
Dots is an app for all things BNS names. The app launched along with [BNSx](../bnsx/intro.md) to allow users to migrate names between BNS and BNSx. Since then, we've added a bunch of other features to make managing your names easier.
...
Yes - check out the docs for [managing multiple accounts](./migrate-multiple-accounts.md).
